...
PreferenceItem preferencesArray[] = {
    ...
    {"ssid", DataType::STRING, {"kuso4ek_raya"}, &ssid, &preferences},
    {"password", DataType::STRING, {"1234567812345678"}, &password, &preferences},
    {"appName", DataType::STRING, {"appName"}, &appName, &preferences},
    {"HOSTNAME", DataType::STRING, {"nicelight_growbox"}, &HOSTNAME, &preferences},
